...
app.layout = html.Div([
    ...
    html.Div(children = ["Is there a Symmetry?",dcc.Dropdown(id='Symmetry_dropdown', options = [{"label": i, "value": i} for i in Mass], value = [], clearable=True), html.Div(id='SYMMETRY_UPDATE')]),
